...
public class FragmentMostPopular extends BaseFragment implements ItemClickListener {
    ...
    public static FragmentMostPopular getInstance(){
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mMovieViewModel.loadMovies(MoviesFilterType.MOVIE_TYPE_MOST_POPULAR);
        mMovieViewModel.getMoviesMostPopular().observe(this, new Observer<List<Movie>>() {
            @Override
            public void onChanged(@Nullable List<Movie> movies) {
                if(movies != null) {
                    movieAdapter = new MoviesRecycleViewAdapter(movies,
                            new PicassoImageLoader());
                    movieAdapter.setClickListener(FragmentMostPopular.this);
